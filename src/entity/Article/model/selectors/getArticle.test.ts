...
describe('tests for getArticle', () => {
    ...
    test('getArticleError with empty state', () => {
        const state = {
            article: {}
        };
    ...
    test('getArticleData', () => {
        ...
        expect(getArticleData(state as StateSchema)).toBe(article);
    });
    test('getArticleData with empty state', () => {
        const state = {
            article: {}
        };
